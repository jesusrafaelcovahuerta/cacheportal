...
Route::post('content/search/{title}/{alliance_id}/{section_id}/{category_id}', 'api\ContentController@index');
Route::post('category/search/{name}/{alliance_id}/{section_id}', 'api\CategoryController@index');
